...
ENV_OVERRIDES: Dict[str, str] = {
    ...
    "canary.enabled": "CANARY_ENABLED",
    "canary.day_of_week": "CANARY_DAY_OF_WEEK",
    "canary.run_time": "CANARY_RUN_TIME",
    "canary.alert_on_stable": "CANARY_ALERT_ON_STABLE",
    "notifications.weekly_digest.enabled": "WEEKLY_DIGEST_ENABLED",
    "notifications.weekly_digest.min_score": "WEEKLY_DIGEST_MIN_SCORE",
    "notifications.weekly_digest.max_rows": "WEEKLY_DIGEST_MAX_ROWS",
    "notifications.weekly_digest.send_time": "WEEKLY_DIGEST_SEND_TIME",
