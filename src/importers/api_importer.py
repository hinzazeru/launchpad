"""3rd party API integration for fetching LinkedIn job postings."""
...
class ApifyJobImporter:
    ...
    def normalize_apify_job(self, job_data: Dict) -> Dict:
...
def create_apify_importer(api_key: Optional[str] = None) -> ApifyJobImporter:
    ...
    Returns:
        ApifyJobImporter instance
    """
    return ApifyJobImporter(api_key=api_key)
